...
function TableUI() {
  ...
  return (
    <div className='ml-72 md:ml-0 gap-4 w-xl mr-4 md:mr-0 md:p-5 m-5 rounded-md min-h-[80px] '>
        <Card className='border border-primary p-5 w-full'>
          <div className='grid grid-cols-3 gap-4 md:grid-cols-2'>
            <Button className='bg-white border border-primary md:text-[10px]'>
            ...
            <Button className='bg-white border border-primary md:text-[10px]' onClick={() => navigate('/admin/add-cashier')}>
        ...
        <Table className='border border-primary mt-4'>
          ...
          <TableBody className='border border-primary '>
              <TableRow className='border border-primary text-center hover:bg-muted/10 hover:bg-[#f3f4f6] transition-colors'>
                ...
                <TableCell className='border border-primary text-center'>
                  <div className='space-x-1 md:space-x-0 slg:space-x-0 md:space-y-1'>
                    {/* View details */}
                    <DropdownMenu>
                      <DropdownMenuTrigger>
